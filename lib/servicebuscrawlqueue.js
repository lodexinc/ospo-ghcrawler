...
class ServiceBusCrawlQueue {
  constructor(url, topic, subscription, formatter) {
    ...
    this.messageFormatter = fomatter;
  }
  ...
  pop() {
    return Q.denodeify(this.serviceBusService.receiveSubscriptionMessage.bind(this.serviceBusService))(this.topic, this.subscription, { isPeekLock: true }).then(messageFormatter);
  }
