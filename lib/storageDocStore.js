...
class AzureStorageDocStore {
  ...
  _getBlobName(type, url) {
    ...
    // TODO this should use pathname not path but lets decide the right thing as other transformations may be needed
    // to account for special chars etc in github entity urls
